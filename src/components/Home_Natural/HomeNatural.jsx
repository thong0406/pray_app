...
import bgTree from '../../assets/bg_Home/bg_mother_nature.png'; // Updated background image
...
const HomeNatural = () => {
    ...
    const navigateToHome = () => {
        navigate('/HomeNatural/SettingsNatural');  
    };
        ...
        <div className="flex flex-col h-screen bg-[#171717] sm:max-w-sm sm:mx-auto relative overflow-hidden">
            <div className="flex justify-between p-4 absolute top-0 left-0 right-0 z-10">
                <img 
                    src={account} 
                    alt="Account Icon" 
                    className="w-8 h-8 hover:scale-110 transform transition duration-200"
